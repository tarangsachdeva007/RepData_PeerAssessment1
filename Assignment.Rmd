...
##Reading the data and Remove the NA values and store in a separate structure for future use
...
#load the ggplot library and Create the aggregated data frame by intervals and day_type
